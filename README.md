...
> [!WARNING]  
>  When creating the rigid body, allign the drone X-axis with the OptiTrack X-axis. 
...
1. This package will read the Optitrack measurements from the topic `/opitrack/rigid_body` 
